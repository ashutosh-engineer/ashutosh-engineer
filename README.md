...
I'm an aspiring **Software Engineer** with a strong foundation in **Data Structures & Algorithms**, backend development, and system-level problem solving. I enjoy building **clean, efficient backend systems**, working with databases, and contributing to **open-source projects** while continuously strengthening my CS fundamentals.
...
|:--------:|:------------|
| <img src="https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white" /> | Data Structures & Algorithms, Competitive Programming |
| <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" /> | Backend Development (Flask), Machine Learning, Deep Learning |
| <img src="https://img.shields.io/badge/SQL-4479A1?style=flat-square&logo=postgresql&logoColor=white" /> | Database Design, Queries, Data Modeling |
...
| | |
|:--|:--|
| 🟢 **Program** | GirlScript Summer of Code (GSSoC) Contributor |
| 🔀 **PRs Merged** | 26+ across multiple repositories |
| 🔧 **Focus Areas** | Backend features, optimizations, bug fixes |
| 📌 **Visibility** | All contributions publicly visible on GitHub |

🔗 [**View All Pull Requests →**](https://github.com/pulls?q=is%3Apr+author%3Aashutosh-engineer)
